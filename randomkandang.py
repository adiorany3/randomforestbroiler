    ...
    if 'interpretasi' in locals() and 'interpretasi_prediksi' in locals():
        if interpretasi != interpretasi_prediksi:
            ...
            new_data = pd.DataFrame([[Age, today, Total_Body_Weight, FCR, Live_Bird, Ayam_Dipelihara, persen_Live_Bird, actual_ip, prediction, culling, ADG_actual, feed]],
                                    columns=['Age', 'Date', 'Total_Body_Weight', 'FCR', 'Live_Bird', 'Ayam_Dipelihara', 'persen_Live_Bird', 'IP_actual', 'IP', 'Culling', 'ADG_actual', 'Feed', 'FCR_actual'])
            try:
                ...
                column_order = ['Age', 'Date', 'Total_Body_Weight', 'FCR', 'Live_Bird', 'Ayam_Dipelihara', 'persen_Live_Bird', 'IP_actual', 'IP', 'Culling', 'ADG_actual', 'Feed', 'FCR_actual']
